...
public class Fatigability_Dungeon {
	
	public static void main(String[] args) {
		Solution5 sl = new Solution5();
		int[][] intArr = {{80, 20}, {50, 40}, {30, 10}};
		//sl.solution(80, intArr);
		System.out.println(sl.solution(80, intArr));
	}
}
    ...
    public static void dfs(int k, int[][] dungeons, int cnt){
        for(int i = 0; i<dungeons.length;i++){
            if(!check[i] && dungeons[i][0] <= k){
                ...
                check[i] = false;
                System.out.println(cnt + " = " + check[i]);
            }
        }
